...
dependencies {
    testImplementation(project(":dinari-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../dinari-java-core/src/main/resources/META-INF/proguard/dinari-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.dinari.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../dinari-java-core/src/main/resources/META-INF/proguard/dinari-java-core.pro",
