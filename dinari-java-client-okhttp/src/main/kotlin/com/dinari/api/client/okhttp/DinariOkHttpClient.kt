...
import com.dinari.api.client.DinariClientImpl
...
/**
 * A class that allows building an instance of [DinariClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class DinariOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DinariClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): DinariClient = builder().fromEnv().build()
    }

    /** A builder for [DinariOkHttpClient]. */
