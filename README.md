...
[![Maven Central](https://img.shields.io/maven-central/v/com.dinari.api/dinari-java)](https://central.sonatype.com/artifact/com.dinari.api/dinari-java/0.10.0)
[![javadoc](https://javadoc.io/badge2/com.dinari.api/dinari-java/0.10.0/javadoc.svg)](https://javadoc.io/doc/com.dinari.api/dinari-java/0.10.0)
...
The REST API documentation can be found on [docs.dinari.com](https://docs.dinari.com/). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.dinari.api/dinari-java/0.10.0).
...
```kotlin
implementation("com.dinari.api:dinari-java:0.10.0")
```
