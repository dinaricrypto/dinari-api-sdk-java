...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orderRetrieveParams: OrderRetrieveParams) = apply {
            accountId = orderRetrieveParams.accountId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrderRetrieveParams && accountId == other.accountId && orderId == other.orderId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OrderRetrieveParams{accountId=$accountId, orderId=$orderId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
