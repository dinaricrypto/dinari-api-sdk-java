...
@JsonDeserialize(using = OrderRequestListResponse.Deserializer::class)
@JsonSerialize(using = OrderRequestListResponse.Serializer::class)
class OrderRequestListResponse
private constructor(
    private val accountOrderRequests: List<AccountOrderRequest>? = null,
    private val paginatedAccountOrderRequest: PaginatedAccountOrderRequestResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun accountOrderRequests(): Optional<List<AccountOrderRequest>> =
        Optional.ofNullable(accountOrderRequests)

    fun paginatedAccountOrderRequest(): Optional<PaginatedAccountOrderRequestResponse> =
        Optional.ofNullable(paginatedAccountOrderRequest)

    fun isAccountOrderRequests(): Boolean = accountOrderRequests != null

    fun isPaginatedAccountOrderRequest(): Boolean = paginatedAccountOrderRequest != null

    fun asAccountOrderRequests(): List<AccountOrderRequest> =
        accountOrderRequests.getOrThrow("accountOrderRequests")

    fun asPaginatedAccountOrderRequest(): PaginatedAccountOrderRequestResponse =
        paginatedAccountOrderRequest.getOrThrow("paginatedAccountOrderRequest")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = orderRequestListResponse.accept(new OrderRequestListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitAccountOrderRequests(List<AccountOrderRequest> accountOrderRequests) {
     *         return Optional.of(accountOrderRequests.toString());
     *     }
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            accountOrderRequests != null -> visitor.visitAccountOrderRequests(accountOrderRequests)
            paginatedAccountOrderRequest != null ->
                visitor.visitPaginatedAccountOrderRequest(paginatedAccountOrderRequest)
    ...
    fun validate(): OrderRequestListResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitAccountOrderRequests(
                    accountOrderRequests: List<AccountOrderRequest>
                ) {
                    accountOrderRequests.forEach { it.validate() }
                }

                override fun visitPaginatedAccountOrderRequest(
                    paginatedAccountOrderRequest: PaginatedAccountOrderRequestResponse
                ) {
                    paginatedAccountOrderRequest.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitAccountOrderRequests(
                    accountOrderRequests: List<AccountOrderRequest>
                ) = accountOrderRequests.sumOf { it.validity().toInt() }

                override fun visitPaginatedAccountOrderRequest(
                    paginatedAccountOrderRequest: PaginatedAccountOrderRequestResponse
                ) = paginatedAccountOrderRequest.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderRequestListResponse &&
            accountOrderRequests == other.accountOrderRequests &&
            paginatedAccountOrderRequest == other.paginatedAccountOrderRequest
    }

    override fun hashCode(): Int = Objects.hash(accountOrderRequests, paginatedAccountOrderRequest)

    override fun toString(): String =
        when {
            accountOrderRequests != null ->
                "OrderRequestListResponse{accountOrderRequests=$accountOrderRequests}"
            paginatedAccountOrderRequest != null ->
                "OrderRequestListResponse{paginatedAccountOrderRequest=$paginatedAccountOrderRequest}"
            _json != null -> "OrderRequestListResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid OrderRequestListResponse")
        }

    companion object {

        @JvmStatic
        fun ofAccountOrderRequests(accountOrderRequests: List<AccountOrderRequest>) =
            OrderRequestListResponse(accountOrderRequests = accountOrderRequests.toImmutable())
    ...
    /**
     * An interface that defines how to map each variant of [OrderRequestListResponse] to a value of
     * type [T].
     */
    interface Visitor<out T> {

        fun visitAccountOrderRequests(accountOrderRequests: List<AccountOrderRequest>): T

        fun visitPaginatedAccountOrderRequest(
            paginatedAccountOrderRequest: PaginatedAccountOrderRequestResponse
        ): T

        /**
         * Maps an unknown variant of [OrderRequestListResponse] to a value of type [T].
         *
         * An instance of [OrderRequestListResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown OrderRequestListResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<OrderRequestListResponse>(OrderRequestListResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): OrderRequestListResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedAccountOrderRequestResponse>())
                            ?.let {
                                OrderRequestListResponse(
                                    paginatedAccountOrderRequest = it,
                                    _json = json,
                                )
                            },
                        tryDeserialize(node, jacksonTypeRef<List<AccountOrderRequest>>())?.let {
                            OrderRequestListResponse(accountOrderRequests = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> OrderRequestListResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<OrderRequestListResponse>(OrderRequestListResponse::class) {

        override fun serialize(
            value: OrderRequestListResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.accountOrderRequests != null ->
                    generator.writeObject(value.accountOrderRequests)
                value.paginatedAccountOrderRequest != null ->
                    generator.writeObject(value.paginatedAccountOrderRequest)
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [AccountOrderRequest].
             *
        ...
        /** A builder for [AccountOrderRequest]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(accountOrderRequest: AccountOrderRequest) = apply {
                id = accountOrderRequest.id
                accountId = accountOrderRequest.accountId
                createdDt = accountOrderRequest.createdDt
                orderSide = accountOrderRequest.orderSide
                orderTif = accountOrderRequest.orderTif
                orderType = accountOrderRequest.orderType
                status = accountOrderRequest.status
                cancelMessage = accountOrderRequest.cancelMessage
                clientOrderId = accountOrderRequest.clientOrderId
                orderId = accountOrderRequest.orderId
                recipientAccountId = accountOrderRequest.recipientAccountId
                rejectMessage = accountOrderRequest.rejectMessage
                additionalProperties = accountOrderRequest.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [AccountOrderRequest].
             *
         ...
         *   expected type.
         */
        fun validate(): AccountOrderRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AccountOrderRequest &&
                id == other.id &&
    ...
    private constructor(
        ...
        /** A builder for [PaginatedAccountOrderRequestResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(
                paginatedAccountOrderRequestResponse: PaginatedAccountOrderRequestResponse
            ) = apply {
                data = paginatedAccountOrderRequestResponse.data.map { it.toMutableList() }
                paginationMetadata = paginatedAccountOrderRequestResponse.paginationMetadata
                _sv = paginatedAccountOrderRequestResponse._sv
                additionalProperties =
                    paginatedAccountOrderRequestResponse.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [PaginatedAccountOrderRequestResponse].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): PaginatedAccountOrderRequestResponse =
                PaginatedAccountOrderRequestResponse(
         ...
         *   expected type.
         */
        fun validate(): PaginatedAccountOrderRequestResponse = apply {
            if (validated) {
                return@apply
            }
         ...
         * `OrderRequest` is then fulfilled by creating an `Order` on-chain.
         *
         * The `OrderRequest` is a record of the user's intent to place an order, while the `Order`
         * is the actual transaction that occurs on the blockchain.
         */
        class Data
        @JsonCreator(mode = JsonCreator.Mode.DISABLED)
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                /**
                 * ID of `Order` created from the `OrderRequest`. This is the primary identifier for
                 * the `/orders` routes.
                 */
                fun orderId(orderId: String?) = orderId(JsonField.ofNullable(orderId))
                 ...
                 * Sets [Builder.recipientAccountId] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.recipientAccountId] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun recipientAccountId(recipientAccountId: JsonField<String>) = apply {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedAccountOrderRequestResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedAccountOrderRequestResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
