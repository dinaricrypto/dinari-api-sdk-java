...
class EntityRetrieveCurrentResponse
...
private constructor(
    ...
    /** A builder for [EntityRetrieveCurrentResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityRetrieveCurrentResponse: EntityRetrieveCurrentResponse) = apply {
            id = entityRetrieveCurrentResponse.id
            entityType = entityRetrieveCurrentResponse.entityType
            isKycComplete = entityRetrieveCurrentResponse.isKycComplete
            name = entityRetrieveCurrentResponse.name
            nationality = entityRetrieveCurrentResponse.nationality
            referenceId = entityRetrieveCurrentResponse.referenceId
            additionalProperties = entityRetrieveCurrentResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntityRetrieveCurrentResponse].
         *
         ...
         */
        fun build(): EntityRetrieveCurrentResponse =
            EntityRetrieveCurrentResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): EntityRetrieveCurrentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityRetrieveCurrentResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "EntityRetrieveCurrentResponse{id=$id, entityType=$entityType, isKycComplete=$isKycComplete, name=$name, nationality=$nationality, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}
