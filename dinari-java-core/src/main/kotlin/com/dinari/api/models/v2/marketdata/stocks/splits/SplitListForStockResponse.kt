...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SplitListForStockResponse].
         *
    ...
    /** A builder for [SplitListForStockResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(splitListForStockResponse: SplitListForStockResponse) = apply {
            data = splitListForStockResponse.data.map { it.toMutableList() }
            paginationMetadata = splitListForStockResponse.paginationMetadata
            _sv = splitListForStockResponse._sv
            additionalProperties = splitListForStockResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SplitListForStockResponse].
         *
         ...
         */
        fun build(): SplitListForStockResponse =
    ...
    override fun toString() =
        "SplitListForStockResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
