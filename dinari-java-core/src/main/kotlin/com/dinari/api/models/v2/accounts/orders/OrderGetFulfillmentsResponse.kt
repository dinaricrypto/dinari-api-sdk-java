...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderGetFulfillmentsResponse].
         *
    ...
    /** A builder for [OrderGetFulfillmentsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderGetFulfillmentsResponse: OrderGetFulfillmentsResponse) = apply {
            data = orderGetFulfillmentsResponse.data.map { it.toMutableList() }
            paginationMetadata = orderGetFulfillmentsResponse.paginationMetadata
            _sv = orderGetFulfillmentsResponse._sv
            additionalProperties = orderGetFulfillmentsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderGetFulfillmentsResponse].
         *
         ...
         */
        fun build(): OrderGetFulfillmentsResponse =
    ...
    override fun toString() =
        "OrderGetFulfillmentsResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
