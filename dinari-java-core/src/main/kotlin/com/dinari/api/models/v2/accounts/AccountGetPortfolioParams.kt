...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AccountGetPortfolioParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AccountGetPortfolioParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AccountGetPortfolioParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AccountGetPortfolioParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountGetPortfolioParams && accountId == other.accountId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
