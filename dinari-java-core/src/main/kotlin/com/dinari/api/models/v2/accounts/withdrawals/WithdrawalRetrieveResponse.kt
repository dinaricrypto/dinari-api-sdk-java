 ...
 * `Wallet`.
 */
class WithdrawalRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WithdrawalRetrieveResponse].
         *
    ...
    /** A builder for [WithdrawalRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(withdrawalRetrieveResponse: WithdrawalRetrieveResponse) = apply {
            id = withdrawalRetrieveResponse.id
            accountId = withdrawalRetrieveResponse.accountId
            chainId = withdrawalRetrieveResponse.chainId
            paymentTokenAddress = withdrawalRetrieveResponse.paymentTokenAddress
            paymentTokenAmount = withdrawalRetrieveResponse.paymentTokenAmount
            recipientAccountId = withdrawalRetrieveResponse.recipientAccountId
            status = withdrawalRetrieveResponse.status
            transactionDt = withdrawalRetrieveResponse.transactionDt
            transactionHash = withdrawalRetrieveResponse.transactionHash
            withdrawalRequestId = withdrawalRetrieveResponse.withdrawalRequestId
            additionalProperties = withdrawalRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WithdrawalRetrieveResponse].
         *
         ...
         */
        fun build(): WithdrawalRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): WithdrawalRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WithdrawalRetrieveResponse &&
            id == other.id &&
