...
class OrderFulfillmentQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OrderFulfillmentQueryParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [OrderFulfillmentQueryParams].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderFulfillmentQueryParams: OrderFulfillmentQueryParams) = apply {
            accountId = orderFulfillmentQueryParams.accountId
            limit = orderFulfillmentQueryParams.limit
            next = orderFulfillmentQueryParams.next
            order = orderFulfillmentQueryParams.order
            orderIds = orderFulfillmentQueryParams.orderIds?.toMutableList()
            page = orderFulfillmentQueryParams.page
            pageSize = orderFulfillmentQueryParams.pageSize
            previous = orderFulfillmentQueryParams.previous
            additionalHeaders = orderFulfillmentQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = orderFulfillmentQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrderFulfillmentQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrderFulfillmentQueryParams =
    ...
    override fun toString() =
        "OrderFulfillmentQueryParams{accountId=$accountId, limit=$limit, next=$next, order=$order, orderIds=$orderIds, page=$page, pageSize=$pageSize, previous=$previous, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
