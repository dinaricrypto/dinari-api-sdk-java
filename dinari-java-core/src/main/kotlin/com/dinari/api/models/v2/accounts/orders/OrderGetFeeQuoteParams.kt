...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderGetFeeQuoteParams].
         *
    ...
    /** A builder for [OrderGetFeeQuoteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderGetFeeQuoteParams: OrderGetFeeQuoteParams) = apply {
            accountId = orderGetFeeQuoteParams.accountId
            body = orderGetFeeQuoteParams.body.toBuilder()
            additionalHeaders = orderGetFeeQuoteParams.additionalHeaders.toBuilder()
            additionalQueryParams = orderGetFeeQuoteParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrderGetFeeQuoteParams].
         *
         ...
         */
        fun build(): OrderGetFeeQuoteParams =
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && chainId == other.chainId && contractAddress == other.contractAddress && orderSide == other.orderSide && orderTif == other.orderTif && orderType == other.orderType && stockId == other.stockId && assetTokenQuantity == other.assetTokenQuantity && limitPrice == other.limitPrice && paymentToken == other.paymentToken && paymentTokenQuantity == other.paymentTokenQuantity && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(chainId, contractAddress, orderSide, orderTif, orderType, stockId, assetTokenQuantity, limitPrice, paymentToken, paymentTokenQuantity, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{chainId=$chainId, contractAddress=$contractAddress, orderSide=$orderSide, orderTif=$orderTif, orderType=$orderType, stockId=$stockId, assetTokenQuantity=$assetTokenQuantity, limitPrice=$limitPrice, paymentToken=$paymentToken, paymentTokenQuantity=$paymentTokenQuantity, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrderGetFeeQuoteParams && accountId == other.accountId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(accountId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "OrderGetFeeQuoteParams{accountId=$accountId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
