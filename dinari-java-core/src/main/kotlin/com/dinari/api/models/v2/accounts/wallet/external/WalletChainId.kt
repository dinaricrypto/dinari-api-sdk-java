...
class WalletChainId @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmField val EIP155_31337 = of("eip155:31337")

        @JvmField val EIP155_1337 = of("eip155:1337")

        @JvmStatic fun of(value: String) = WalletChainId(JsonField.of(value))
    }

    /** An enum containing [WalletChainId]'s known values. */
    enum class Known {
        EIP155_0,
        EIP155_1,
        EIP155_42161,
    ...
    /**
     * An enum containing [WalletChainId]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [WalletChainId] can contain an unknown value in a couple of cases:
    ...
    fun value(): Value =
        when (this) {
            ...
            EIP155_31337 -> Value.EIP155_31337
            EIP155_1337 -> Value.EIP155_1337
            else -> Value._UNKNOWN
        }
    ...
    fun known(): Known =
        when (this) {
            ...
            EIP155_31337 -> Known.EIP155_31337
            EIP155_1337 -> Known.EIP155_1337
    ...
    fun validate(): WalletChainId = apply {
        if (validated) {
            return@apply
        }
