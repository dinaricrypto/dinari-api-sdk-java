...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveResponse: AccountRetrieveResponse) = apply {
            ...
            createdDt = accountRetrieveResponse.createdDt
            entityId = accountRetrieveResponse.entityId
            isActive = accountRetrieveResponse.isActive
            jurisdiction = accountRetrieveResponse.jurisdiction
            brokerageAccountId = accountRetrieveResponse.brokerageAccountId
    ...
    override fun toString() =
        "AccountRetrieveResponse{id=$id, createdDt=$createdDt, entityId=$entityId, isActive=$isActive, jurisdiction=$jurisdiction, brokerageAccountId=$brokerageAccountId, additionalProperties=$additionalProperties}"
}
