...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orderGetFulfillmentsParams: OrderGetFulfillmentsParams) = apply {
            ...
            limit = orderGetFulfillmentsParams.limit
            next = orderGetFulfillmentsParams.next
            order = orderGetFulfillmentsParams.order
            page = orderGetFulfillmentsParams.page
            pageSize = orderGetFulfillmentsParams.pageSize
            previous = orderGetFulfillmentsParams.previous
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderGetFulfillmentsParams &&
    ...
    override fun toString() =
        "OrderGetFulfillmentsParams{accountId=$accountId, orderId=$orderId, limit=$limit, next=$next, order=$order, page=$page, pageSize=$pageSize, previous=$previous, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
