...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(alloyListParams: AlloyListParams) = apply {
            limit = alloyListParams.limit
            next = alloyListParams.next
            order = alloyListParams.order
            previous = alloyListParams.previous
            symbols = alloyListParams.symbols?.toMutableList()
            additionalHeaders = alloyListParams.additionalHeaders.toBuilder()
            additionalQueryParams = alloyListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AlloyListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AlloyListParams =
            AlloyListParams(
                limit,
                next,
                order,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlloyListParams &&
            limit == other.limit &&
            next == other.next &&
            order == other.order &&
    ...
    override fun toString() =
        "AlloyListParams{limit=$limit, next=$next, order=$order, previous=$previous, symbols=$symbols, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
