...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrderFeeAmount && feeInEth == other.feeInEth && feeInWei == other.feeInWei && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
