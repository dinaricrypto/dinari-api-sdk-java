...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KycUploadDocumentResponse].
         *
    ...
    /** A builder for [KycUploadDocumentResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(kycUploadDocumentResponse: KycUploadDocumentResponse) = apply {
            id = kycUploadDocumentResponse.id
            documentType = kycUploadDocumentResponse.documentType
            filename = kycUploadDocumentResponse.filename
            url = kycUploadDocumentResponse.url
        ...
        /**
         * Returns an immutable instance of [KycUploadDocumentResponse].
         *
         ...
         */
        fun build(): KycUploadDocumentResponse =
    ...
    fun validate(): KycUploadDocumentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is KycUploadDocumentResponse && id == other.id && documentType == other.documentType && filename == other.filename && url == other.url && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(id, documentType, filename, url, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "KycUploadDocumentResponse{id=$id, documentType=$documentType, filename=$filename, url=$url, additionalProperties=$additionalProperties}"
}
