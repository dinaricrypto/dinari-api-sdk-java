...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LimitOrderRequestInput].
         *
    ...
    /** A builder for [LimitOrderRequestInput]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(limitOrderRequestInput: LimitOrderRequestInput) = apply {
            assetQuantity = limitOrderRequestInput.assetQuantity
            limitPrice = limitOrderRequestInput.limitPrice
            stockId = limitOrderRequestInput.stockId
        ...
        /**
         * Returns an immutable instance of [LimitOrderRequestInput].
         *
         ...
         */
        fun build(): LimitOrderRequestInput =
    ...
    fun validate(): LimitOrderRequestInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LimitOrderRequestInput && assetQuantity == other.assetQuantity && limitPrice == other.limitPrice && stockId == other.stockId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "LimitOrderRequestInput{assetQuantity=$assetQuantity, limitPrice=$limitPrice, stockId=$stockId, additionalProperties=$additionalProperties}"
}
