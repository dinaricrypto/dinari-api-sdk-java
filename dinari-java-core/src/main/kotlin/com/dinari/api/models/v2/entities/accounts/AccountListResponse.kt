...
@JsonDeserialize(using = AccountListResponse.Deserializer::class)
@JsonSerialize(using = AccountListResponse.Serializer::class)
class AccountListResponse
private constructor(
    private val accounts: List<Account>? = null,
    private val paginatedAccount: PaginatedAccountResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun accounts(): Optional<List<Account>> = Optional.ofNullable(accounts)

    fun paginatedAccount(): Optional<PaginatedAccountResponse> =
        Optional.ofNullable(paginatedAccount)

    fun isAccounts(): Boolean = accounts != null

    fun isPaginatedAccount(): Boolean = paginatedAccount != null

    fun asAccounts(): List<Account> = accounts.getOrThrow("accounts")

    fun asPaginatedAccount(): PaginatedAccountResponse =
        paginatedAccount.getOrThrow("paginatedAccount")
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            ...
            paginatedAccount != null -> visitor.visitPaginatedAccount(paginatedAccount)
    ...
    fun validate(): AccountListResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitAccounts(accounts: List<Account>) {
                    accounts.forEach { it.validate() }
                }

                override fun visitPaginatedAccount(paginatedAccount: PaginatedAccountResponse) {
                    paginatedAccount.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitAccounts(accounts: List<Account>) =
                    accounts.sumOf { it.validity().toInt() }

                override fun visitPaginatedAccount(paginatedAccount: PaginatedAccountResponse) =
                    paginatedAccount.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountListResponse &&
            ...
            paginatedAccount == other.paginatedAccount
    }

    override fun hashCode(): Int = Objects.hash(accounts, paginatedAccount)

    override fun toString(): String =
        when {
            accounts != null -> "AccountListResponse{accounts=$accounts}"
            paginatedAccount != null -> "AccountListResponse{paginatedAccount=$paginatedAccount}"
            _json != null -> "AccountListResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid AccountListResponse")
        }

    companion object {

        @JvmStatic
        fun ofAccounts(accounts: List<Account>) =
            AccountListResponse(accounts = accounts.toImmutable())

        @JvmStatic
        fun ofPaginatedAccount(paginatedAccount: PaginatedAccountResponse) =
            AccountListResponse(paginatedAccount = paginatedAccount)
    }

    /**
     * An interface that defines how to map each variant of [AccountListResponse] to a value of type
     * [T].
     */
    interface Visitor<out T> {

        fun visitAccounts(accounts: List<Account>): T

        fun visitPaginatedAccount(paginatedAccount: PaginatedAccountResponse): T

        /**
         * Maps an unknown variant of [AccountListResponse] to a value of type [T].
         *
         * An instance of [AccountListResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown AccountListResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<AccountListResponse>(AccountListResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): AccountListResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedAccountResponse>())?.let {
                            AccountListResponse(paginatedAccount = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<Account>>())?.let {
                            AccountListResponse(accounts = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> AccountListResponse(_json = json)
    ...
    internal class Serializer : BaseSerializer<AccountListResponse>(AccountListResponse::class) {
        ...
        override fun serialize(
            ...
            when {
                value.accounts != null -> generator.writeObject(value.accounts)
                value.paginatedAccount != null -> generator.writeObject(value.paginatedAccount)
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PaginatedAccountResponse].
             *
        ...
        /** A builder for [PaginatedAccountResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paginatedAccountResponse: PaginatedAccountResponse) = apply {
                data = paginatedAccountResponse.data.map { it.toMutableList() }
                paginationMetadata = paginatedAccountResponse.paginationMetadata
                _sv = paginatedAccountResponse._sv
                additionalProperties = paginatedAccountResponse.additionalProperties.toMutableMap()
            }
             ...
             *
             * You should usually call [Builder.data] with a well-typed `List<Account>` value
            ...
            /**
             * Returns an immutable instance of [PaginatedAccountResponse].
             *
             ...
             */
            fun build(): PaginatedAccountResponse =
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedAccountResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedAccountResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
