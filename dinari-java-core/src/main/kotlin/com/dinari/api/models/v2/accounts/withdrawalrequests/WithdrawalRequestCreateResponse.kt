 ...
 */
class WithdrawalRequestCreateResponse
...
private constructor(
    ...
    /** A builder for [WithdrawalRequestCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(withdrawalRequestCreateResponse: WithdrawalRequestCreateResponse) =
            apply {
                id = withdrawalRequestCreateResponse.id
                accountId = withdrawalRequestCreateResponse.accountId
                createdDt = withdrawalRequestCreateResponse.createdDt
                paymentTokenAmount = withdrawalRequestCreateResponse.paymentTokenAmount
                recipientAccountId = withdrawalRequestCreateResponse.recipientAccountId
                status = withdrawalRequestCreateResponse.status
                updatedDt = withdrawalRequestCreateResponse.updatedDt
                additionalProperties =
                    withdrawalRequestCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [WithdrawalRequestCreateResponse].
         *
         ...
         */
        fun build(): WithdrawalRequestCreateResponse =
            WithdrawalRequestCreateResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): WithdrawalRequestCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WithdrawalRequestCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "WithdrawalRequestCreateResponse{id=$id, accountId=$accountId, createdDt=$createdDt, paymentTokenAmount=$paymentTokenAmount, recipientAccountId=$recipientAccountId, status=$status, updatedDt=$updatedDt, additionalProperties=$additionalProperties}"
}
