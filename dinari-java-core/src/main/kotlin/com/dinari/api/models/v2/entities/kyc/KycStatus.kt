...
class KycStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmField val NEEDS_REVIEW = of("NEEDS_REVIEW")

        @JvmStatic fun of(value: String) = KycStatus(JsonField.of(value))
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw DinariInvalidDataException("Unknown KycStatus: $value")
        }
