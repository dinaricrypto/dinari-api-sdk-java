...
private constructor(
    ...
    /** A builder for [AccountRetrieveDividendPaymentsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            accountRetrieveDividendPaymentsResponse: AccountRetrieveDividendPaymentsResponse
        ) = apply {
            amount = accountRetrieveDividendPaymentsResponse.amount
            currency = accountRetrieveDividendPaymentsResponse.currency
            paymentDate = accountRetrieveDividendPaymentsResponse.paymentDate
            stockId = accountRetrieveDividendPaymentsResponse.stockId
            additionalProperties =
                accountRetrieveDividendPaymentsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountRetrieveDividendPaymentsResponse].
         *
         ...
         */
        fun build(): AccountRetrieveDividendPaymentsResponse =
            AccountRetrieveDividendPaymentsResponse(
    ...
    fun validate(): AccountRetrieveDividendPaymentsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountRetrieveDividendPaymentsResponse && amount == other.amount && currency == other.currency && paymentDate == other.paymentDate && stockId == other.stockId && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(amount, currency, paymentDate, stockId, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AccountRetrieveDividendPaymentsResponse{amount=$amount, currency=$currency, paymentDate=$paymentDate, stockId=$stockId, additionalProperties=$additionalProperties}"
}
