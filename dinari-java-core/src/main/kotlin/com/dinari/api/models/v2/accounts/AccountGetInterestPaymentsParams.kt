...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountGetInterestPaymentsParams: AccountGetInterestPaymentsParams) =
            apply {
                ...
                limit = accountGetInterestPaymentsParams.limit
                next = accountGetInterestPaymentsParams.next
                order = accountGetInterestPaymentsParams.order
                page = accountGetInterestPaymentsParams.page
                pageSize = accountGetInterestPaymentsParams.pageSize
                previous = accountGetInterestPaymentsParams.previous
    ...
    override fun toString() =
        "AccountGetInterestPaymentsParams{accountId=$accountId, endDate=$endDate, startDate=$startDate, limit=$limit, next=$next, order=$order, page=$page, pageSize=$pageSize, previous=$previous, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
