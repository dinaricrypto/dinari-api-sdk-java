...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stockRetrieveCurrentQuoteResponse: StockRetrieveCurrentQuoteResponse) =
            apply {
                ...
                _sv = stockRetrieveCurrentQuoteResponse._sv
    ...
    override fun toString() =
        "StockRetrieveCurrentQuoteResponse{askPrice=$askPrice, askSize=$askSize, bidPrice=$bidPrice, bidSize=$bidSize, stockId=$stockId, timestamp=$timestamp, _sv=$_sv, additionalProperties=$additionalProperties}"
}
