...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SplitListResponse].
         *
    ...
    /** A builder for [SplitListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(splitListResponse: SplitListResponse) = apply {
            data = splitListResponse.data.map { it.toMutableList() }
            paginationMetadata = splitListResponse.paginationMetadata
            _sv = splitListResponse._sv
            additionalProperties = splitListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SplitListResponse].
         *
    ...
    override fun toString() =
        "SplitListResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
