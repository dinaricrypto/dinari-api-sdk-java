...
@JsonDeserialize(using = SplitListResponse.Deserializer::class)
@JsonSerialize(using = SplitListResponse.Serializer::class)
...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = splitListResponse.accept(new SplitListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitStockSplits(List<StockSplit> stockSplits) {
     *         return Optional.of(stockSplits.toString());
     *     }
     *
     *     // ...
     *
     ...
     *   expected type.
     */
    fun validate(): SplitListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SplitListResponse &&
    ...
    override fun toString(): String =
        when {
            stockSplits != null -> "SplitListResponse{stockSplits=$stockSplits}"
            paginatedStockSplit != null ->
                "SplitListResponse{paginatedStockSplit=$paginatedStockSplit}"
            _json != null -> "SplitListResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid SplitListResponse")
        }
    ...
    companion object {
        ...
        fun ofStockSplits(stockSplits: List<StockSplit>) =
            SplitListResponse(stockSplits = stockSplits.toImmutable())
    ...
    /**
     * An interface that defines how to map each variant of [SplitListResponse] to a value of type
     * [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [SplitListResponse] to a value of type [T].
         *
         * An instance of [SplitListResponse] can contain an unknown variant if it was deserialized
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown SplitListResponse: $json")
        }
    }

    internal class Deserializer : BaseDeserializer<SplitListResponse>(SplitListResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): SplitListResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedStockSplitResponse>())?.let {
                            SplitListResponse(paginatedStockSplit = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<StockSplit>>())?.let {
                            SplitListResponse(stockSplits = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> SplitListResponse(_json = json)
    ...
    internal class Serializer : BaseSerializer<SplitListResponse>(SplitListResponse::class) {
