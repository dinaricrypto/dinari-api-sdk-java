...
@JsonDeserialize(using = EntityListResponse.Deserializer::class)
@JsonSerialize(using = EntityListResponse.Serializer::class)
class EntityListResponse
private constructor(
    private val entities: List<Entity>? = null,
    private val paginatedEntity: PaginatedEntityResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun entities(): Optional<List<Entity>> = Optional.ofNullable(entities)

    fun paginatedEntity(): Optional<PaginatedEntityResponse> = Optional.ofNullable(paginatedEntity)

    fun isEntities(): Boolean = entities != null

    fun isPaginatedEntity(): Boolean = paginatedEntity != null

    fun asEntities(): List<Entity> = entities.getOrThrow("entities")

    fun asPaginatedEntity(): PaginatedEntityResponse = paginatedEntity.getOrThrow("paginatedEntity")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = entityListResponse.accept(new EntityListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitEntities(List<Entity> entities) {
     *         return Optional.of(entities.toString());
     *     }
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            entities != null -> visitor.visitEntities(entities)
            paginatedEntity != null -> visitor.visitPaginatedEntity(paginatedEntity)
    ...
    fun validate(): EntityListResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitEntities(entities: List<Entity>) {
                    entities.forEach { it.validate() }
                }

                override fun visitPaginatedEntity(paginatedEntity: PaginatedEntityResponse) {
                    paginatedEntity.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitEntities(entities: List<Entity>) =
                    entities.sumOf { it.validity().toInt() }

                override fun visitPaginatedEntity(paginatedEntity: PaginatedEntityResponse) =
                    paginatedEntity.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityListResponse &&
            ...
            paginatedEntity == other.paginatedEntity
    }

    override fun hashCode(): Int = Objects.hash(entities, paginatedEntity)

    override fun toString(): String =
        when {
            entities != null -> "EntityListResponse{entities=$entities}"
            paginatedEntity != null -> "EntityListResponse{paginatedEntity=$paginatedEntity}"
            _json != null -> "EntityListResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid EntityListResponse")
        }

    companion object {

        @JvmStatic
        fun ofEntities(entities: List<Entity>) =
            EntityListResponse(entities = entities.toImmutable())

        @JvmStatic
        fun ofPaginatedEntity(paginatedEntity: PaginatedEntityResponse) =
            EntityListResponse(paginatedEntity = paginatedEntity)
    }

    /**
     * An interface that defines how to map each variant of [EntityListResponse] to a value of type
     * [T].
     */
    interface Visitor<out T> {

        fun visitEntities(entities: List<Entity>): T

        fun visitPaginatedEntity(paginatedEntity: PaginatedEntityResponse): T

        /**
         * Maps an unknown variant of [EntityListResponse] to a value of type [T].
         *
         * An instance of [EntityListResponse] can contain an unknown variant if it was deserialized
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown EntityListResponse: $json")
        }
    }

    internal class Deserializer : BaseDeserializer<EntityListResponse>(EntityListResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): EntityListResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedEntityResponse>())?.let {
                            EntityListResponse(paginatedEntity = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<Entity>>())?.let {
                            EntityListResponse(entities = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> EntityListResponse(_json = json)
    ...
    internal class Serializer : BaseSerializer<EntityListResponse>(EntityListResponse::class) {
        ...
        override fun serialize(
            ...
            when {
                value.entities != null -> generator.writeObject(value.entities)
                value.paginatedEntity != null -> generator.writeObject(value.paginatedEntity)
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PaginatedEntityResponse].
             *
        ...
        /** A builder for [PaginatedEntityResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paginatedEntityResponse: PaginatedEntityResponse) = apply {
                data = paginatedEntityResponse.data.map { it.toMutableList() }
                paginationMetadata = paginatedEntityResponse.paginationMetadata
                _sv = paginatedEntityResponse._sv
                additionalProperties = paginatedEntityResponse.additionalProperties.toMutableMap()
            }
             ...
             *
             * You should usually call [Builder.data] with a well-typed `List<Entity>` value
            ...
            /**
             * Returns an immutable instance of [PaginatedEntityResponse].
             *
             ...
             */
            fun build(): PaginatedEntityResponse =
         ...
         *   expected type.
         */
        fun validate(): PaginatedEntityResponse = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedEntityResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedEntityResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
