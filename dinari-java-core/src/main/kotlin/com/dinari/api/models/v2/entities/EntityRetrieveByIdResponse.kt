...
class EntityRetrieveByIdResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityRetrieveByIdResponse].
         *
    ...
    /** A builder for [EntityRetrieveByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityRetrieveByIdResponse: EntityRetrieveByIdResponse) = apply {
            id = entityRetrieveByIdResponse.id
            entityType = entityRetrieveByIdResponse.entityType
            isKycComplete = entityRetrieveByIdResponse.isKycComplete
            name = entityRetrieveByIdResponse.name
            nationality = entityRetrieveByIdResponse.nationality
            referenceId = entityRetrieveByIdResponse.referenceId
            additionalProperties = entityRetrieveByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntityRetrieveByIdResponse].
         *
         ...
         */
        fun build(): EntityRetrieveByIdResponse =
     ...
     *   expected type.
     */
    fun validate(): EntityRetrieveByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityRetrieveByIdResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "EntityRetrieveByIdResponse{id=$id, entityType=$entityType, isKycComplete=$isKycComplete, name=$name, nationality=$nationality, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}
