...
private constructor(
    ...
    /** A builder for [AccountRetrieveCashParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountRetrieveCashParams: AccountRetrieveCashParams) = apply {
            accountId = accountRetrieveCashParams.accountId
            additionalHeaders = accountRetrieveCashParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountRetrieveCashParams && accountId == other.accountId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(accountId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AccountRetrieveCashParams{accountId=$accountId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
