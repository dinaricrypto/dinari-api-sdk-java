...
class PaginatedOrderFulfillment
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaginatedOrderFulfillment].
         *
    ...
    /** A builder for [PaginatedOrderFulfillment]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paginatedOrderFulfillment: PaginatedOrderFulfillment) = apply {
            data = paginatedOrderFulfillment.data.map { it.toMutableList() }
            paginationMetadata = paginatedOrderFulfillment.paginationMetadata
            _sv = paginatedOrderFulfillment._sv
            additionalProperties = paginatedOrderFulfillment.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaginatedOrderFulfillment].
         *
         ...
         */
        fun build(): PaginatedOrderFulfillment =
     ...
     *   expected type.
     */
    fun validate(): PaginatedOrderFulfillment = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaginatedOrderFulfillment &&
            data == other.data &&
    ...
    override fun toString() =
        "PaginatedOrderFulfillment{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
