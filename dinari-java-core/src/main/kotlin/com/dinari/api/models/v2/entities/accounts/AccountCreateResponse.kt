...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountCreateResponse: AccountCreateResponse) = apply {
            ...
            createdDt = accountCreateResponse.createdDt
            entityId = accountCreateResponse.entityId
            isActive = accountCreateResponse.isActive
            jurisdiction = accountCreateResponse.jurisdiction
            brokerageAccountId = accountCreateResponse.brokerageAccountId
    ...
    override fun toString() =
        "AccountCreateResponse{id=$id, createdDt=$createdDt, entityId=$entityId, isActive=$isActive, jurisdiction=$jurisdiction, brokerageAccountId=$brokerageAccountId, additionalProperties=$additionalProperties}"
}
