...
private constructor(
    ...
    override fun toString() =
        "OrderListParams{accountId=$accountId, chainId=$chainId, clientOrderId=$clientOrderId, limit=$limit, next=$next, order=$order, orderTransactionHash=$orderTransactionHash, previous=$previous, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
