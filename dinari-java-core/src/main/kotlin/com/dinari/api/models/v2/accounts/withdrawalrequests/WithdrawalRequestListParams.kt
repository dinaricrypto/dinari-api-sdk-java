...
class WithdrawalRequestListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WithdrawalRequestListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [WithdrawalRequestListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WithdrawalRequestListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(withdrawalRequestListParams: WithdrawalRequestListParams) = apply {
            accountId = withdrawalRequestListParams.accountId
            limit = withdrawalRequestListParams.limit
            next = withdrawalRequestListParams.next
            order = withdrawalRequestListParams.order
            page = withdrawalRequestListParams.page
            pageSize = withdrawalRequestListParams.pageSize
            previous = withdrawalRequestListParams.previous
            additionalHeaders = withdrawalRequestListParams.additionalHeaders.toBuilder()
            additionalQueryParams = withdrawalRequestListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WithdrawalRequestListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WithdrawalRequestListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WithdrawalRequestListParams &&
    ...
    override fun toString() =
        "WithdrawalRequestListParams{accountId=$accountId, limit=$limit, next=$next, order=$order, page=$page, pageSize=$pageSize, previous=$previous, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
