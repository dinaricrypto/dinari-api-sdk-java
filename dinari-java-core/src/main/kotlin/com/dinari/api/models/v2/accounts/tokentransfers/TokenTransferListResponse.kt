...
@JsonDeserialize(using = TokenTransferListResponse.Deserializer::class)
@JsonSerialize(using = TokenTransferListResponse.Serializer::class)
class TokenTransferListResponse
private constructor(
    private val transfers: List<TokenTransfer>? = null,
    private val paginatedTokenTransfer: PaginatedTokenTransferResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun transfers(): Optional<List<TokenTransfer>> = Optional.ofNullable(transfers)

    fun paginatedTokenTransfer(): Optional<PaginatedTokenTransferResponse> =
        Optional.ofNullable(paginatedTokenTransfer)

    fun isTransfers(): Boolean = transfers != null

    fun isPaginatedTokenTransfer(): Boolean = paginatedTokenTransfer != null

    fun asTransfers(): List<TokenTransfer> = transfers.getOrThrow("transfers")

    fun asPaginatedTokenTransfer(): PaginatedTokenTransferResponse =
        paginatedTokenTransfer.getOrThrow("paginatedTokenTransfer")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = tokenTransferListResponse.accept(new TokenTransferListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitTransfers(List<TokenTransfer> transfers) {
     *         return Optional.of(transfers.toString());
     *     }
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            transfers != null -> visitor.visitTransfers(transfers)
            paginatedTokenTransfer != null ->
                visitor.visitPaginatedTokenTransfer(paginatedTokenTransfer)
    ...
    fun validate(): TokenTransferListResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitTransfers(transfers: List<TokenTransfer>) {
                    transfers.forEach { it.validate() }
                }

                override fun visitPaginatedTokenTransfer(
                    paginatedTokenTransfer: PaginatedTokenTransferResponse
                ) {
                    paginatedTokenTransfer.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitTransfers(transfers: List<TokenTransfer>) =
                    transfers.sumOf { it.validity().toInt() }

                override fun visitPaginatedTokenTransfer(
                    paginatedTokenTransfer: PaginatedTokenTransferResponse
                ) = paginatedTokenTransfer.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenTransferListResponse &&
            ...
            paginatedTokenTransfer == other.paginatedTokenTransfer
    }

    override fun hashCode(): Int = Objects.hash(transfers, paginatedTokenTransfer)

    override fun toString(): String =
        when {
            transfers != null -> "TokenTransferListResponse{transfers=$transfers}"
            paginatedTokenTransfer != null ->
                "TokenTransferListResponse{paginatedTokenTransfer=$paginatedTokenTransfer}"
            _json != null -> "TokenTransferListResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid TokenTransferListResponse")
        }

    companion object {

        @JvmStatic
        fun ofTransfers(transfers: List<TokenTransfer>) =
            TokenTransferListResponse(transfers = transfers.toImmutable())

        @JvmStatic
        fun ofPaginatedTokenTransfer(paginatedTokenTransfer: PaginatedTokenTransferResponse) =
            TokenTransferListResponse(paginatedTokenTransfer = paginatedTokenTransfer)
    }

    /**
     * An interface that defines how to map each variant of [TokenTransferListResponse] to a value
     * of type [T].
     */
    interface Visitor<out T> {

        fun visitTransfers(transfers: List<TokenTransfer>): T

        fun visitPaginatedTokenTransfer(paginatedTokenTransfer: PaginatedTokenTransferResponse): T

        /**
         * Maps an unknown variant of [TokenTransferListResponse] to a value of type [T].
         *
         * An instance of [TokenTransferListResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown TokenTransferListResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<TokenTransferListResponse>(TokenTransferListResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): TokenTransferListResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedTokenTransferResponse>())
                            ?.let {
                                TokenTransferListResponse(paginatedTokenTransfer = it, _json = json)
                            },
                        tryDeserialize(node, jacksonTypeRef<List<TokenTransfer>>())?.let {
                            TokenTransferListResponse(transfers = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> TokenTransferListResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<TokenTransferListResponse>(TokenTransferListResponse::class) {

        override fun serialize(
            value: TokenTransferListResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.transfers != null -> generator.writeObject(value.transfers)
                value.paginatedTokenTransfer != null ->
                    generator.writeObject(value.paginatedTokenTransfer)
    ...
    class PaginatedTokenTransferResponse
    ...
    private constructor(
        ...
        /** A builder for [PaginatedTokenTransferResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paginatedTokenTransferResponse: PaginatedTokenTransferResponse) =
                apply {
                    data = paginatedTokenTransferResponse.data.map { it.toMutableList() }
                    paginationMetadata = paginatedTokenTransferResponse.paginationMetadata
                    _sv = paginatedTokenTransferResponse._sv
                    additionalProperties =
                        paginatedTokenTransferResponse.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [PaginatedTokenTransferResponse].
             *
             ...
             */
            fun build(): PaginatedTokenTransferResponse =
                PaginatedTokenTransferResponse(
         ...
         *   expected type.
         */
        fun validate(): PaginatedTokenTransferResponse = apply {
            if (validated) {
                return@apply
            }
        ...
        class _Sv @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun value(): Value =
                when (this) {
                    PAGINATED_TOKEN_TRANSFER_RESPONSE_V1 ->
                        Value.PAGINATED_TOKEN_TRANSFER_RESPONSE_V1
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    PAGINATED_TOKEN_TRANSFER_RESPONSE_V1 ->
                        Known.PAGINATED_TOKEN_TRANSFER_RESPONSE_V1
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedTokenTransferResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedTokenTransferResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
