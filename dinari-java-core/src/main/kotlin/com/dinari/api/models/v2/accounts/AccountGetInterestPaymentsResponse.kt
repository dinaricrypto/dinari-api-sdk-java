...
@JsonDeserialize(using = AccountGetInterestPaymentsResponse.Deserializer::class)
@JsonSerialize(using = AccountGetInterestPaymentsResponse.Serializer::class)
class AccountGetInterestPaymentsResponse
private constructor(
    private val interestPayments: List<InterestPayment>? = null,
    private val paginatedInterestPayment: PaginatedInterestPaymentResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun interestPayments(): Optional<List<InterestPayment>> = Optional.ofNullable(interestPayments)

    fun paginatedInterestPayment(): Optional<PaginatedInterestPaymentResponse> =
        Optional.ofNullable(paginatedInterestPayment)

    fun isInterestPayments(): Boolean = interestPayments != null

    fun isPaginatedInterestPayment(): Boolean = paginatedInterestPayment != null

    fun asInterestPayments(): List<InterestPayment> =
        interestPayments.getOrThrow("interestPayments")

    fun asPaginatedInterestPayment(): PaginatedInterestPaymentResponse =
        paginatedInterestPayment.getOrThrow("paginatedInterestPayment")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = accountGetInterestPaymentsResponse.accept(new AccountGetInterestPaymentsResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitInterestPayments(List<InterestPayment> interestPayments) {
     *         return Optional.of(interestPayments.toString());
     *     }
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            interestPayments != null -> visitor.visitInterestPayments(interestPayments)
            paginatedInterestPayment != null ->
                visitor.visitPaginatedInterestPayment(paginatedInterestPayment)
    ...
    fun validate(): AccountGetInterestPaymentsResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitInterestPayments(interestPayments: List<InterestPayment>) {
                    interestPayments.forEach { it.validate() }
                }

                override fun visitPaginatedInterestPayment(
                    paginatedInterestPayment: PaginatedInterestPaymentResponse
                ) {
                    paginatedInterestPayment.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitInterestPayments(interestPayments: List<InterestPayment>) =
                    interestPayments.sumOf { it.validity().toInt() }

                override fun visitPaginatedInterestPayment(
                    paginatedInterestPayment: PaginatedInterestPaymentResponse
                ) = paginatedInterestPayment.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGetInterestPaymentsResponse &&
            interestPayments == other.interestPayments &&
            paginatedInterestPayment == other.paginatedInterestPayment
    }

    override fun hashCode(): Int = Objects.hash(interestPayments, paginatedInterestPayment)

    override fun toString(): String =
        when {
            interestPayments != null ->
                "AccountGetInterestPaymentsResponse{interestPayments=$interestPayments}"
            paginatedInterestPayment != null ->
                "AccountGetInterestPaymentsResponse{paginatedInterestPayment=$paginatedInterestPayment}"
            _json != null -> "AccountGetInterestPaymentsResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid AccountGetInterestPaymentsResponse")
        }

    companion object {

        @JvmStatic
        fun ofInterestPayments(interestPayments: List<InterestPayment>) =
            AccountGetInterestPaymentsResponse(interestPayments = interestPayments.toImmutable())

        @JvmStatic
        fun ofPaginatedInterestPayment(paginatedInterestPayment: PaginatedInterestPaymentResponse) =
            AccountGetInterestPaymentsResponse(paginatedInterestPayment = paginatedInterestPayment)
    }

    /**
     * An interface that defines how to map each variant of [AccountGetInterestPaymentsResponse] to
     * a value of type [T].
     */
    interface Visitor<out T> {

        fun visitInterestPayments(interestPayments: List<InterestPayment>): T

        fun visitPaginatedInterestPayment(
            paginatedInterestPayment: PaginatedInterestPaymentResponse
        ): T

        /**
         * Maps an unknown variant of [AccountGetInterestPaymentsResponse] to a value of type [T].
         *
         * An instance of [AccountGetInterestPaymentsResponse] can contain an unknown variant if it
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown AccountGetInterestPaymentsResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<AccountGetInterestPaymentsResponse>(
            AccountGetInterestPaymentsResponse::class
        ) {

        override fun ObjectCodec.deserialize(node: JsonNode): AccountGetInterestPaymentsResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedInterestPaymentResponse>())
                            ?.let {
                                AccountGetInterestPaymentsResponse(
                                    paginatedInterestPayment = it,
                                    _json = json,
                                )
                            },
                        tryDeserialize(node, jacksonTypeRef<List<InterestPayment>>())?.let {
                            AccountGetInterestPaymentsResponse(interestPayments = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> AccountGetInterestPaymentsResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<AccountGetInterestPaymentsResponse>(
            AccountGetInterestPaymentsResponse::class
        ) {

        override fun serialize(
            value: AccountGetInterestPaymentsResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.interestPayments != null -> generator.writeObject(value.interestPayments)
                value.paginatedInterestPayment != null ->
                    generator.writeObject(value.paginatedInterestPayment)
    ...
    private constructor(
        ...
        override fun toString() =
            "InterestPayment{amount=$amount, currency=$currency, paymentDate=$paymentDate, additionalProperties=$additionalProperties}"
    }

    class PaginatedInterestPaymentResponse
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        ...
        /** A builder for [PaginatedInterestPaymentResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paginatedInterestPaymentResponse: PaginatedInterestPaymentResponse) =
                apply {
                    data = paginatedInterestPaymentResponse.data.map { it.toMutableList() }
                    paginationMetadata = paginatedInterestPaymentResponse.paginationMetadata
                    _sv = paginatedInterestPaymentResponse._sv
                    additionalProperties =
                        paginatedInterestPaymentResponse.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [PaginatedInterestPaymentResponse].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): PaginatedInterestPaymentResponse =
                PaginatedInterestPaymentResponse(
         ...
         *   expected type.
         */
        fun validate(): PaginatedInterestPaymentResponse = apply {
            if (validated) {
                return@apply
            }
        ...
        private constructor(
            ...
            override fun toString() =
                "Data{amount=$amount, currency=$currency, paymentDate=$paymentDate, additionalProperties=$additionalProperties}"
        }
        ...
        class _Sv @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField
                val PAGINATED_INTEREST_PAYMENT_RESPONSE_V1 =
                    of("PaginatedInterestPaymentResponse:v1")
            ...
            fun value(): Value =
                when (this) {
                    PAGINATED_INTEREST_PAYMENT_RESPONSE_V1 ->
                        Value.PAGINATED_INTEREST_PAYMENT_RESPONSE_V1
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    PAGINATED_INTEREST_PAYMENT_RESPONSE_V1 ->
                        Known.PAGINATED_INTEREST_PAYMENT_RESPONSE_V1
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedInterestPaymentResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedInterestPaymentResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
