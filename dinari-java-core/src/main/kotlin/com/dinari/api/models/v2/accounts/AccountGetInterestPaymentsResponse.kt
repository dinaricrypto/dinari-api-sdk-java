...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountGetInterestPaymentsResponse: AccountGetInterestPaymentsResponse) =
            apply {
                data = accountGetInterestPaymentsResponse.data.map { it.toMutableList() }
                paginationMetadata = accountGetInterestPaymentsResponse.paginationMetadata
                _sv = accountGetInterestPaymentsResponse._sv
    ...
    class _Sv @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val PAGINATED_INTEREST_PAYMENT_RESPONSE_V1 = of("PaginatedInterestPaymentResponse:v1")
    ...
    override fun toString() =
        "AccountGetInterestPaymentsResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
