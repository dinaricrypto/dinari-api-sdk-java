...
@JsonDeserialize(using = V2ListOrdersResponse.Deserializer::class)
@JsonSerialize(using = V2ListOrdersResponse.Serializer::class)
class V2ListOrdersResponse
private constructor(
    private val entityOrders: List<EntityOrder>? = null,
    private val paginatedEntityOrder: PaginatedEntityOrderResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun entityOrders(): Optional<List<EntityOrder>> = Optional.ofNullable(entityOrders)

    fun paginatedEntityOrder(): Optional<PaginatedEntityOrderResponse> =
        Optional.ofNullable(paginatedEntityOrder)

    fun isEntityOrders(): Boolean = entityOrders != null

    fun isPaginatedEntityOrder(): Boolean = paginatedEntityOrder != null

    fun asEntityOrders(): List<EntityOrder> = entityOrders.getOrThrow("entityOrders")

    fun asPaginatedEntityOrder(): PaginatedEntityOrderResponse =
        paginatedEntityOrder.getOrThrow("paginatedEntityOrder")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = v2ListOrdersResponse.accept(new V2ListOrdersResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitEntityOrders(List<EntityOrder> entityOrders) {
     *         return Optional.of(entityOrders.toString());
     *     }
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            entityOrders != null -> visitor.visitEntityOrders(entityOrders)
            paginatedEntityOrder != null -> visitor.visitPaginatedEntityOrder(paginatedEntityOrder)
    ...
    fun validate(): V2ListOrdersResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitEntityOrders(entityOrders: List<EntityOrder>) {
                    entityOrders.forEach { it.validate() }
                }

                override fun visitPaginatedEntityOrder(
                    paginatedEntityOrder: PaginatedEntityOrderResponse
                ) {
                    paginatedEntityOrder.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitEntityOrders(entityOrders: List<EntityOrder>) =
                    entityOrders.sumOf { it.validity().toInt() }

                override fun visitPaginatedEntityOrder(
                    paginatedEntityOrder: PaginatedEntityOrderResponse
                ) = paginatedEntityOrder.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V2ListOrdersResponse &&
            entityOrders == other.entityOrders &&
            paginatedEntityOrder == other.paginatedEntityOrder
    }

    override fun hashCode(): Int = Objects.hash(entityOrders, paginatedEntityOrder)

    override fun toString(): String =
        when {
            entityOrders != null -> "V2ListOrdersResponse{entityOrders=$entityOrders}"
            paginatedEntityOrder != null ->
                "V2ListOrdersResponse{paginatedEntityOrder=$paginatedEntityOrder}"
            _json != null -> "V2ListOrdersResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid V2ListOrdersResponse")
        }

    companion object {

        @JvmStatic
        fun ofEntityOrders(entityOrders: List<EntityOrder>) =
            V2ListOrdersResponse(entityOrders = entityOrders.toImmutable())

        @JvmStatic
        fun ofPaginatedEntityOrder(paginatedEntityOrder: PaginatedEntityOrderResponse) =
            V2ListOrdersResponse(paginatedEntityOrder = paginatedEntityOrder)
    }

    /**
     * An interface that defines how to map each variant of [V2ListOrdersResponse] to a value of
     * type [T].
     */
    interface Visitor<out T> {

        fun visitEntityOrders(entityOrders: List<EntityOrder>): T

        fun visitPaginatedEntityOrder(paginatedEntityOrder: PaginatedEntityOrderResponse): T

        /**
         * Maps an unknown variant of [V2ListOrdersResponse] to a value of type [T].
         *
         * An instance of [V2ListOrdersResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown V2ListOrdersResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<V2ListOrdersResponse>(V2ListOrdersResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): V2ListOrdersResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedEntityOrderResponse>())?.let {
                            V2ListOrdersResponse(paginatedEntityOrder = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<EntityOrder>>())?.let {
                            V2ListOrdersResponse(entityOrders = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> V2ListOrdersResponse(_json = json)
    ...
    internal class Serializer : BaseSerializer<V2ListOrdersResponse>(V2ListOrdersResponse::class) {

        override fun serialize(
            value: V2ListOrdersResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.entityOrders != null -> generator.writeObject(value.entityOrders)
                value.paginatedEntityOrder != null ->
                    generator.writeObject(value.paginatedEntityOrder)
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [EntityOrder].
             *
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(entityOrder: EntityOrder) = apply {
                id = entityOrder.id
                chainId = entityOrder.chainId
                createdDt = entityOrder.createdDt
                orderContractAddress = entityOrder.orderContractAddress
                orderSide = entityOrder.orderSide
                orderTif = entityOrder.orderTif
                orderTransactionHash = entityOrder.orderTransactionHash
                orderType = entityOrder.orderType
                paymentToken = entityOrder.paymentToken
                status = entityOrder.status
                stockId = entityOrder.stockId
                accountId = entityOrder.accountId
                assetToken = entityOrder.assetToken
                assetTokenQuantity = entityOrder.assetTokenQuantity
                cancelTransactionHash = entityOrder.cancelTransactionHash
                clientOrderId = entityOrder.clientOrderId
                entityId = entityOrder.entityId
                fee = entityOrder.fee
                limitPrice = entityOrder.limitPrice
                orderRequestId = entityOrder.orderRequestId
                paymentTokenQuantity = entityOrder.paymentTokenQuantity
                additionalProperties = entityOrder.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [EntityOrder].
             *
         ...
         *   expected type.
         */
        fun validate(): EntityOrder = apply {
            if (validated) {
                return@apply
            }
    ...
    private constructor(
        ...
        /** A builder for [PaginatedEntityOrderResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paginatedEntityOrderResponse: PaginatedEntityOrderResponse) = apply {
                data = paginatedEntityOrderResponse.data.map { it.toMutableList() }
                paginationMetadata = paginatedEntityOrderResponse.paginationMetadata
                _sv = paginatedEntityOrderResponse._sv
                additionalProperties =
                    paginatedEntityOrderResponse.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [PaginatedEntityOrderResponse].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): PaginatedEntityOrderResponse =
                PaginatedEntityOrderResponse(
         ...
         *   expected type.
         */
        fun validate(): PaginatedEntityOrderResponse = apply {
            if (validated) {
                return@apply
            }
        ...
        class _Sv @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField
                val PAGINATED_ENTITY_ORDER_RESPONSE_V1 = of("PaginatedEntityOrderResponse:v1")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedEntityOrderResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedEntityOrderResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
