...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entityListParams: EntityListParams) = apply {
            ...
            next = entityListParams.next
            order = entityListParams.order
            page = entityListParams.page
            pageSize = entityListParams.pageSize
            previous = entityListParams.previous
    ...
    override fun toString() =
        "EntityListParams{limit=$limit, next=$next, order=$order, page=$page, pageSize=$pageSize, previous=$previous, referenceId=$referenceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
