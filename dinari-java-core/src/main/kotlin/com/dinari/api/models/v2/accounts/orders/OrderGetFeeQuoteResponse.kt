...
class OrderGetFeeQuoteResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderGetFeeQuoteResponse].
         *
    ...
    /** A builder for [OrderGetFeeQuoteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderGetFeeQuoteResponse: OrderGetFeeQuoteResponse) = apply {
            chainId = orderGetFeeQuoteResponse.chainId
            fee = orderGetFeeQuoteResponse.fee
            orderFeeContractObject = orderGetFeeQuoteResponse.orderFeeContractObject
            additionalProperties = orderGetFeeQuoteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderGetFeeQuoteResponse].
         *
         ...
         */
        fun build(): OrderGetFeeQuoteResponse =
    ...
    fun validate(): OrderGetFeeQuoteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.fees] with a well-typed `List<Fee>` value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fees(fees: JsonField<List<Fee>>) = apply {
        ...
        private constructor(
             ...
             *
             * Unlike [feeInEth], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("fee_in_eth")
            @ExcludeMissing
            fun _feeInEth(): JsonField<Double> = feeInEth

            /**
             * Returns the raw JSON value of [feeInWei].
             *
             * Unlike [feeInWei], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("fee_in_wei")
            @ExcludeMissing
            fun _feeInWei(): JsonField<String> = feeInWei
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.feeInEth] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.feeInWei] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is OrderFeeContractObject && chainId == other.chainId && feeQuote == other.feeQuote && feeQuoteSignature == other.feeQuoteSignature && fees == other.fees && paymentToken == other.paymentToken && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrderGetFeeQuoteResponse && chainId == other.chainId && fee == other.fee && orderFeeContractObject == other.orderFeeContractObject && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(chainId, fee, orderFeeContractObject, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "OrderGetFeeQuoteResponse{chainId=$chainId, fee=$fee, orderFeeContractObject=$orderFeeContractObject, additionalProperties=$additionalProperties}"
}
