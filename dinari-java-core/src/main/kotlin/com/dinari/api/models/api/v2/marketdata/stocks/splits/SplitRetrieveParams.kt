...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(splitRetrieveParams: SplitRetrieveParams) = apply {
            stockId = splitRetrieveParams.stockId
            page = splitRetrieveParams.page
            pageSize = splitRetrieveParams.pageSize
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SplitRetrieveParams && stockId == other.stockId && page == other.page && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(stockId, page, pageSize, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SplitRetrieveParams{stockId=$stockId, page=$page, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
