...
private constructor(
    ...
    /** A builder for [AccountRetrieveDividendPaymentsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            accountRetrieveDividendPaymentsParams: AccountRetrieveDividendPaymentsParams
        ) = apply {
            accountId = accountRetrieveDividendPaymentsParams.accountId
            endDate = accountRetrieveDividendPaymentsParams.endDate
            startDate = accountRetrieveDividendPaymentsParams.startDate
            page = accountRetrieveDividendPaymentsParams.page
            pageSize = accountRetrieveDividendPaymentsParams.pageSize
            stockId = accountRetrieveDividendPaymentsParams.stockId
            additionalHeaders = accountRetrieveDividendPaymentsParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountRetrieveDividendPaymentsParams && accountId == other.accountId && endDate == other.endDate && startDate == other.startDate && page == other.page && pageSize == other.pageSize && stockId == other.stockId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AccountRetrieveDividendPaymentsParams{accountId=$accountId, endDate=$endDate, startDate=$startDate, page=$page, pageSize=$pageSize, stockId=$stockId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
