...
@JsonDeserialize(using = AccountGetDividendPaymentsResponse.Deserializer::class)
@JsonSerialize(using = AccountGetDividendPaymentsResponse.Serializer::class)
class AccountGetDividendPaymentsResponse
private constructor(
    private val dividendPayments: List<DividendPayment>? = null,
    private val paginatedDividendPayment: PaginatedDividendPaymentResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun dividendPayments(): Optional<List<DividendPayment>> = Optional.ofNullable(dividendPayments)

    fun paginatedDividendPayment(): Optional<PaginatedDividendPaymentResponse> =
        Optional.ofNullable(paginatedDividendPayment)

    fun isDividendPayments(): Boolean = dividendPayments != null

    fun isPaginatedDividendPayment(): Boolean = paginatedDividendPayment != null

    fun asDividendPayments(): List<DividendPayment> =
        dividendPayments.getOrThrow("dividendPayments")

    fun asPaginatedDividendPayment(): PaginatedDividendPaymentResponse =
        paginatedDividendPayment.getOrThrow("paginatedDividendPayment")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = accountGetDividendPaymentsResponse.accept(new AccountGetDividendPaymentsResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitDividendPayments(List<DividendPayment> dividendPayments) {
     *         return Optional.of(dividendPayments.toString());
     *     }
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            dividendPayments != null -> visitor.visitDividendPayments(dividendPayments)
            paginatedDividendPayment != null ->
                visitor.visitPaginatedDividendPayment(paginatedDividendPayment)
    ...
    fun validate(): AccountGetDividendPaymentsResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitDividendPayments(dividendPayments: List<DividendPayment>) {
                    dividendPayments.forEach { it.validate() }
                }

                override fun visitPaginatedDividendPayment(
                    paginatedDividendPayment: PaginatedDividendPaymentResponse
                ) {
                    paginatedDividendPayment.validate()
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitDividendPayments(dividendPayments: List<DividendPayment>) =
                    dividendPayments.sumOf { it.validity().toInt() }

                override fun visitPaginatedDividendPayment(
                    paginatedDividendPayment: PaginatedDividendPaymentResponse
                ) = paginatedDividendPayment.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGetDividendPaymentsResponse &&
            dividendPayments == other.dividendPayments &&
            paginatedDividendPayment == other.paginatedDividendPayment
    }

    override fun hashCode(): Int = Objects.hash(dividendPayments, paginatedDividendPayment)

    override fun toString(): String =
        when {
            dividendPayments != null ->
                "AccountGetDividendPaymentsResponse{dividendPayments=$dividendPayments}"
            paginatedDividendPayment != null ->
                "AccountGetDividendPaymentsResponse{paginatedDividendPayment=$paginatedDividendPayment}"
            _json != null -> "AccountGetDividendPaymentsResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid AccountGetDividendPaymentsResponse")
        }

    companion object {

        @JvmStatic
        fun ofDividendPayments(dividendPayments: List<DividendPayment>) =
            AccountGetDividendPaymentsResponse(dividendPayments = dividendPayments.toImmutable())

        @JvmStatic
        fun ofPaginatedDividendPayment(paginatedDividendPayment: PaginatedDividendPaymentResponse) =
            AccountGetDividendPaymentsResponse(paginatedDividendPayment = paginatedDividendPayment)
    }

    /**
     * An interface that defines how to map each variant of [AccountGetDividendPaymentsResponse] to
     * a value of type [T].
     */
    interface Visitor<out T> {

        fun visitDividendPayments(dividendPayments: List<DividendPayment>): T

        fun visitPaginatedDividendPayment(
            paginatedDividendPayment: PaginatedDividendPaymentResponse
        ): T

        /**
         * Maps an unknown variant of [AccountGetDividendPaymentsResponse] to a value of type [T].
         *
         * An instance of [AccountGetDividendPaymentsResponse] can contain an unknown variant if it
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown AccountGetDividendPaymentsResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<AccountGetDividendPaymentsResponse>(
            AccountGetDividendPaymentsResponse::class
        ) {

        override fun ObjectCodec.deserialize(node: JsonNode): AccountGetDividendPaymentsResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedDividendPaymentResponse>())
                            ?.let {
                                AccountGetDividendPaymentsResponse(
                                    paginatedDividendPayment = it,
                                    _json = json,
                                )
                            },
                        tryDeserialize(node, jacksonTypeRef<List<DividendPayment>>())?.let {
                            AccountGetDividendPaymentsResponse(dividendPayments = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> AccountGetDividendPaymentsResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<AccountGetDividendPaymentsResponse>(
            AccountGetDividendPaymentsResponse::class
        ) {

        override fun serialize(
            value: AccountGetDividendPaymentsResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.dividendPayments != null -> generator.writeObject(value.dividendPayments)
                value.paginatedDividendPayment != null ->
                    generator.writeObject(value.paginatedDividendPayment)
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [DividendPayment].
             *
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(dividendPayment: DividendPayment) = apply {
                amount = dividendPayment.amount
                currency = dividendPayment.currency
                paymentDate = dividendPayment.paymentDate
                stockId = dividendPayment.stockId
                additionalProperties = dividendPayment.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [DividendPayment].
             *
         ...
         *   expected type.
         */
        fun validate(): DividendPayment = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is DividendPayment &&
                amount == other.amount &&
        ...
        override fun toString() =
            "DividendPayment{amount=$amount, currency=$currency, paymentDate=$paymentDate, stockId=$stockId, additionalProperties=$additionalProperties}"
    }

    class PaginatedDividendPaymentResponse
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        ...
        /** A builder for [PaginatedDividendPaymentResponse]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paginatedDividendPaymentResponse: PaginatedDividendPaymentResponse) =
                apply {
                    data = paginatedDividendPaymentResponse.data.map { it.toMutableList() }
                    paginationMetadata = paginatedDividendPaymentResponse.paginationMetadata
                    _sv = paginatedDividendPaymentResponse._sv
                    additionalProperties =
                        paginatedDividendPaymentResponse.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [PaginatedDividendPaymentResponse].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): PaginatedDividendPaymentResponse =
                PaginatedDividendPaymentResponse(
         ...
         *   expected type.
         */
        fun validate(): PaginatedDividendPaymentResponse = apply {
            if (validated) {
                return@apply
            }
        ...
        class _Sv @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField
                val PAGINATED_DIVIDEND_PAYMENT_RESPONSE_V1 =
                    of("PaginatedDividendPaymentResponse:v1")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PaginatedDividendPaymentResponse &&
                data == other.data &&
        ...
        override fun toString() =
            "PaginatedDividendPaymentResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
    }
}
