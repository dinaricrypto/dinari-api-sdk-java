...
class MarketDataGetMarketHoursResponse
private constructor(
    ...
    /** A builder for [MarketDataGetMarketHoursResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(marketDataGetMarketHoursResponse: MarketDataGetMarketHoursResponse) =
            apply {
                isMarketOpen = marketDataGetMarketHoursResponse.isMarketOpen
                nextSessionCloseDt = marketDataGetMarketHoursResponse.nextSessionCloseDt
                nextSessionOpenDt = marketDataGetMarketHoursResponse.nextSessionOpenDt
                currentSessionCloseDt = marketDataGetMarketHoursResponse.currentSessionCloseDt
                currentSessionOpenDt = marketDataGetMarketHoursResponse.currentSessionOpenDt
                additionalProperties =
                    marketDataGetMarketHoursResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MarketDataGetMarketHoursResponse].
         *
         ...
         */
        fun build(): MarketDataGetMarketHoursResponse =
            MarketDataGetMarketHoursResponse(
    ...
    fun validate(): MarketDataGetMarketHoursResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "MarketDataGetMarketHoursResponse{isMarketOpen=$isMarketOpen, nextSessionCloseDt=$nextSessionCloseDt, nextSessionOpenDt=$nextSessionOpenDt, currentSessionCloseDt=$currentSessionCloseDt, currentSessionOpenDt=$currentSessionOpenDt, additionalProperties=$additionalProperties}"
}
