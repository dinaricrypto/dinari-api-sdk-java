...
private constructor(
    ...
    /**
     * URL of a managed KYC flow interface for the entity. This URL is unique per KYC attempt.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KycGetUrlResponse].
         *
    ...
    /** A builder for [KycGetUrlResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(kycGetUrlResponse: KycGetUrlResponse) = apply {
            embedUrl = kycGetUrlResponse.embedUrl
            expirationDt = kycGetUrlResponse.expirationDt
            additionalProperties = kycGetUrlResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KycGetUrlResponse].
         *
    ...
    fun validate(): KycGetUrlResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is KycGetUrlResponse && embedUrl == other.embedUrl && expirationDt == other.expirationDt && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "KycGetUrlResponse{embedUrl=$embedUrl, expirationDt=$expirationDt, additionalProperties=$additionalProperties}"
}
