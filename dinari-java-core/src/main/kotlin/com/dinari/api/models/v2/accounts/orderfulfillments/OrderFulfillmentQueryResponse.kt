...
private constructor(
    ...
    /** A builder for [OrderFulfillmentQueryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderFulfillmentQueryResponse: OrderFulfillmentQueryResponse) = apply {
            data = orderFulfillmentQueryResponse.data.map { it.toMutableList() }
            paginationMetadata = orderFulfillmentQueryResponse.paginationMetadata
            _sv = orderFulfillmentQueryResponse._sv
            additionalProperties = orderFulfillmentQueryResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderFulfillmentQueryResponse].
         *
         ...
         */
        fun build(): OrderFulfillmentQueryResponse =
            OrderFulfillmentQueryResponse(
    ...
    override fun toString() =
        "OrderFulfillmentQueryResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
