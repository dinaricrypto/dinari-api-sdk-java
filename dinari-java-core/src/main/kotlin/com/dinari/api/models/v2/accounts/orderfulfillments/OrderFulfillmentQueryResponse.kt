...
@JsonDeserialize(using = OrderFulfillmentQueryResponse.Deserializer::class)
@JsonSerialize(using = OrderFulfillmentQueryResponse.Serializer::class)
class OrderFulfillmentQueryResponse
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = orderFulfillmentQueryResponse.accept(new OrderFulfillmentQueryResponse.Visitor<Optional<String>>() {
     *     @Override
     ...
     *   expected type.
     */
    fun validate(): OrderFulfillmentQueryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderFulfillmentQueryResponse &&
    ...
    override fun toString(): String =
        when {
            accountOrderFulfillments != null ->
                "OrderFulfillmentQueryResponse{accountOrderFulfillments=$accountOrderFulfillments}"
            paginatedAccountOrderFulfillment != null ->
                "OrderFulfillmentQueryResponse{paginatedAccountOrderFulfillment=$paginatedAccountOrderFulfillment}"
            _json != null -> "OrderFulfillmentQueryResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid OrderFulfillmentQueryResponse")
        }
    ...
    /**
     * An interface that defines how to map each variant of [OrderFulfillmentQueryResponse] to a
     * value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [OrderFulfillmentQueryResponse] to a value of type [T].
         *
         * An instance of [OrderFulfillmentQueryResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw DinariInvalidDataException("Unknown OrderFulfillmentQueryResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<OrderFulfillmentQueryResponse>(OrderFulfillmentQueryResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): OrderFulfillmentQueryResponse {
            ...
            return when (bestMatches.size) {
                ...
                0 -> OrderFulfillmentQueryResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<OrderFulfillmentQueryResponse>(OrderFulfillmentQueryResponse::class) {

        override fun serialize(
            value: OrderFulfillmentQueryResponse,
