...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Withdrawal>> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WithdrawalListResponse].
         *
    ...
    /** A builder for [WithdrawalListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(withdrawalListResponse: WithdrawalListResponse) = apply {
            data = withdrawalListResponse.data.map { it.toMutableList() }
            paginationMetadata = withdrawalListResponse.paginationMetadata
            _sv = withdrawalListResponse._sv
            additionalProperties = withdrawalListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WithdrawalListResponse].
         *
         ...
         */
        fun build(): WithdrawalListResponse =
    ...
    class _Sv @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PAGINATED_WITHDRAWAL_RESPONSE_V1 = of("PaginatedWithdrawalResponse:v1")
    ...
    override fun toString() =
        "WithdrawalListResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
