...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityUpdateResponse].
         *
    ...
    /** A builder for [EntityUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityUpdateResponse: EntityUpdateResponse) = apply {
            id = entityUpdateResponse.id
            entityType = entityUpdateResponse.entityType
            isKycComplete = entityUpdateResponse.isKycComplete
            name = entityUpdateResponse.name
            nationality = entityUpdateResponse.nationality
            referenceId = entityUpdateResponse.referenceId
            additionalProperties = entityUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntityUpdateResponse].
         *
         ...
         */
        fun build(): EntityUpdateResponse =
    ...
    fun validate(): EntityUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "EntityUpdateResponse{id=$id, entityType=$entityType, isKycComplete=$isKycComplete, name=$name, nationality=$nationality, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}
