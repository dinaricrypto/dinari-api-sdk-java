...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entityCreateResponse: EntityCreateResponse) = apply {
            id = entityCreateResponse.id
            entityType = entityCreateResponse.entityType
            isKycComplete = entityCreateResponse.isKycComplete
            name = entityCreateResponse.name
            nationality = entityCreateResponse.nationality
            referenceId = entityCreateResponse.referenceId
    ...
    override fun toString() =
        "EntityCreateResponse{id=$id, entityType=$entityType, isKycComplete=$isKycComplete, name=$name, nationality=$nationality, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}
