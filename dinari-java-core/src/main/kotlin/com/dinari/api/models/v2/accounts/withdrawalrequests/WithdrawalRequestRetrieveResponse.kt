 ...
 */
class WithdrawalRequestRetrieveResponse
...
private constructor(
    ...
    /** A builder for [WithdrawalRequestRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(withdrawalRequestRetrieveResponse: WithdrawalRequestRetrieveResponse) =
            apply {
                id = withdrawalRequestRetrieveResponse.id
                accountId = withdrawalRequestRetrieveResponse.accountId
                createdDt = withdrawalRequestRetrieveResponse.createdDt
                paymentTokenAmount = withdrawalRequestRetrieveResponse.paymentTokenAmount
                recipientAccountId = withdrawalRequestRetrieveResponse.recipientAccountId
                status = withdrawalRequestRetrieveResponse.status
                updatedDt = withdrawalRequestRetrieveResponse.updatedDt
                additionalProperties =
                    withdrawalRequestRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [WithdrawalRequestRetrieveResponse].
         *
         ...
         */
        fun build(): WithdrawalRequestRetrieveResponse =
            WithdrawalRequestRetrieveResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): WithdrawalRequestRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WithdrawalRequestRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "WithdrawalRequestRetrieveResponse{id=$id, accountId=$accountId, createdDt=$createdDt, paymentTokenAmount=$paymentTokenAmount, recipientAccountId=$recipientAccountId, status=$status, updatedDt=$updatedDt, additionalProperties=$additionalProperties}"
}
