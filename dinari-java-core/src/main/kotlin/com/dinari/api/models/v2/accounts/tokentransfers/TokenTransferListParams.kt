...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TokenTransferListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TokenTransferListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TokenTransferListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tokenTransferListParams: TokenTransferListParams) = apply {
            accountId = tokenTransferListParams.accountId
            limit = tokenTransferListParams.limit
            next = tokenTransferListParams.next
            order = tokenTransferListParams.order
            page = tokenTransferListParams.page
            pageSize = tokenTransferListParams.pageSize
            previous = tokenTransferListParams.previous
            additionalHeaders = tokenTransferListParams.additionalHeaders.toBuilder()
            additionalQueryParams = tokenTransferListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TokenTransferListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TokenTransferListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenTransferListParams &&
    ...
    override fun toString() =
        "TokenTransferListParams{accountId=$accountId, limit=$limit, next=$next, order=$order, page=$page, pageSize=$pageSize, previous=$previous, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
