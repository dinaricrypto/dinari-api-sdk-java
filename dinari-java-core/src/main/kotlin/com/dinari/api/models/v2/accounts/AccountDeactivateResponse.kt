...
class AccountDeactivateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountDeactivateResponse].
         *
    ...
    /** A builder for [AccountDeactivateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountDeactivateResponse: AccountDeactivateResponse) = apply {
            id = accountDeactivateResponse.id
            createdDt = accountDeactivateResponse.createdDt
            entityId = accountDeactivateResponse.entityId
            isActive = accountDeactivateResponse.isActive
            jurisdiction = accountDeactivateResponse.jurisdiction
            brokerageAccountId = accountDeactivateResponse.brokerageAccountId
            additionalProperties = accountDeactivateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountDeactivateResponse].
         *
         ...
         */
        fun build(): AccountDeactivateResponse =
    ...
    fun validate(): AccountDeactivateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountDeactivateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "AccountDeactivateResponse{id=$id, createdDt=$createdDt, entityId=$entityId, isActive=$isActive, jurisdiction=$jurisdiction, brokerageAccountId=$brokerageAccountId, additionalProperties=$additionalProperties}"
}
