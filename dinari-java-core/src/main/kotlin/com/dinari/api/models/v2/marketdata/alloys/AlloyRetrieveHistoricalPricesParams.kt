...
/**
 * Get historical price data for a specified `Alloy`. Each index in the array represents a single
 * tick in a price chart.
 */
class AlloyRetrieveHistoricalPricesParams
private constructor(
    private val alloyId: String?,
    private val timespan: Timespan,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun alloyId(): Optional<String> = Optional.ofNullable(alloyId)
    ...
    /** A builder for [AlloyRetrieveHistoricalPricesParams]. */
    class Builder internal constructor() {

        private var alloyId: String? = null
        ...
        @JvmSynthetic
        internal fun from(
            alloyRetrieveHistoricalPricesParams: AlloyRetrieveHistoricalPricesParams
        ) = apply {
            alloyId = alloyRetrieveHistoricalPricesParams.alloyId
            timespan = alloyRetrieveHistoricalPricesParams.timespan
            additionalHeaders = alloyRetrieveHistoricalPricesParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                alloyRetrieveHistoricalPricesParams.additionalQueryParams.toBuilder()
        }

        fun alloyId(alloyId: String?) = apply { this.alloyId = alloyId }
        ...
        /**
         * Returns an immutable instance of [AlloyRetrieveHistoricalPricesParams].
         *
         ...
         */
        fun build(): AlloyRetrieveHistoricalPricesParams =
            AlloyRetrieveHistoricalPricesParams(
                alloyId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlloyRetrieveHistoricalPricesParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(alloyId, timespan, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "AlloyRetrieveHistoricalPricesParams{alloyId=$alloyId, timespan=$timespan, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
