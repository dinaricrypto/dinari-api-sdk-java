...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stockListResponse: StockListResponse) = apply {
            data = stockListResponse.data.map { it.toMutableList() }
            paginationMetadata = stockListResponse.paginationMetadata
            _sv = stockListResponse._sv
    ...
    override fun toString() =
        "StockListResponse{data=$data, paginationMetadata=$paginationMetadata, _sv=$_sv, additionalProperties=$additionalProperties}"
}
