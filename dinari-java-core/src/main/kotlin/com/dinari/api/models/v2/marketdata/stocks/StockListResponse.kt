...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = stockListResponse.accept(new StockListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitStocks(List<Stock> stocks) {
     *         return Optional.of(stocks.toString());
     *     }
     *
     *     // ...
     *
