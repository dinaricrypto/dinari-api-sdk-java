...
interface Eip155ServiceAsync {
    ...
    fun createPermit(
        params: Eip155CreatePermitParams
    ): CompletableFuture<Eip155CreatePermitResponse> = createPermit(params, RequestOptions.none())
    ...
    ): CompletableFuture<Eip155SubmitResponse> = submit(accountId, params, RequestOptions.none())
    ...
    /** @see submit */
    fun submit(params: Eip155SubmitParams): CompletableFuture<Eip155SubmitResponse> =
    ...
    interface WithRawResponse {
         ...
         * the same as [Eip155ServiceAsync.createPermitTransaction].
         */
        fun createPermitTransaction(
            accountId: String,
            params: Eip155CreatePermitTransactionParams,
