...
interface OrderServiceAsync {
    ...
    ): CompletableFuture<OrderBatchCancelResponse> =
    ...
    /** @see batchCancel */
    fun batchCancel(params: OrderBatchCancelParams): CompletableFuture<OrderBatchCancelResponse> =
    ...
    interface WithRawResponse {
         ...
         * is otherwise the same as [OrderServiceAsync.batchCancel].
         */
        fun batchCancel(
            accountId: String,
            params: OrderBatchCancelParams,
        ): CompletableFuture<HttpResponseFor<OrderBatchCancelResponse>> =
            batchCancel(accountId, params, RequestOptions.none())
