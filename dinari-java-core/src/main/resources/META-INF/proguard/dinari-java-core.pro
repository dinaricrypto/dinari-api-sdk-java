...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.dinari.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.dinari.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.dinari.api.** {
    <init>(...);
