            ...
            V2ListOrdersResponse.builder()
                .addData(
                    V2ListOrdersResponse.Data.builder()
                        ...
                        .orderSide(V2ListOrdersResponse.Data.OrderSide.BUY)
                        .orderTif(V2ListOrdersResponse.Data.OrderTif.DAY)
                        .orderTransactionHash("0xeaF12bD1DfFd")
                        .orderType(V2ListOrdersResponse.Data.OrderType.MARKET)
                        .paymentToken("payment_token")
                        .status(V2ListOrdersResponse.Data.Status.PENDING_SUBMIT)
                ...
                .paginationMetadata(
                    V2ListOrdersResponse.PaginationMetadata.builder()
                        .next("next")
                        .previous("previous")
                        .build()
                )
